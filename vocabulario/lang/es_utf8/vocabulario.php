...
$string['campo_lex'] = 'Campo temático';
$string['campo_gram'] = 'Gram&aacute;tica';
$string['campo_intencion'] = 'Intenci&oacute;n Comunicativa';
$string['campo_intencion_nuevo'] = 'Crear nueva intenci&oacute;n';
$string['campo_tipologia'] = 'Tipolog&iacute;a textual';
$string['ejem'] = 'Ejemplo';
$string['pal'] = 'Palabra';
$string['Tpal'] = 'Significado';
$string['gen'] = 'G&eacute;nero';
...
$string['pret'] = 'Pret&eacute;rito';
$string['part'] = 'Participio';
$string['sindec'] = 'Sin declinaci&oacute;n';
$string['otr_sus'] = 'Otro';
...
$string['adgr'] = 'Añadir descripci&oacute;n';
$string['error_sus'] = 'No has escrito ninguna palabra para guardarla';
$string['ver'] = 'Buscar';
$string['guardar'] = 'Guardar nueva palabra';
$string['editar'] = 'Editar';
$string['eliminar'] = 'Eliminar';
$string['atras'] = 'Atr&aacute;s';
$string['id'] = 'Identificador';
$string['todo'] = 'Combinaciones completas';
$string['alfabetico'] = 'Alfab&eacute;tico';
...
$string['nivel'] = 'Guardar un subapartado de';
$string['alumnos'] = 'Alumnos del curso';
$string['pal_gr'] = 'Palabras relacionadas con esta gram&aacute;tica';
$string['pal_ic'] = 'Palabras relacionadas con esta intenci&oacute;n comunicativa';
$string['pal_tt'] = 'Palabras relacionadas con esta tipolog&iacute;a textual';
...
$string['konjugier'] = 'Konjugier tes Verb';
