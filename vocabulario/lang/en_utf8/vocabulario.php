...
$string['impr_tipol'] = 'Text typology';
$string['impr_inten'] = 'Communicative intentions';
$string['impr_estra'] = 'Learning strategies';
$string['add_gram'] = 'Add new grammar';
...
$string['tipologias_may'] = 'TEXT TYPOLOGY';
$string['estrategias_may'] = 'LEARNING STRATEGIES';
$string['intenciones_may'] = 'COMMUNICATIVE INTENTIONS';
$string['campo_intencion'] = 'Communicative intention';
$string['campo_intencion_nuevo'] = 'Name of the new comm. intention';
$string['campo_gramatica_nueva'] = 'Name of the new grammatical aspect';
$string['campo_lexico_nuevo'] = 'Name of the new tematic field';
$string['campo_tipologia'] = 'Text typology';
$string['campo_tipologia_nuevo'] = 'Name of the new kind of text';
$string['campo_estrategia_nuevo'] = 'Name of the new activity';
$string['campo_estrategia'] = 'Choose an activity';
...
$string['anotar'] = 'Write down';
$string['busc'] = 'Search and organize';
$string['nuevos'] = 'Create new fields';
...
$string['pal_gr'] = 'Words related with this grammmar aspect';
$string['pal_ic'] = 'Words related with this communicative intention';
$string['pal_tt'] = 'Words related with this text typology';
$string['especificar_gr'] = 'Specify grammar';
$string['especificar_inten'] = 'Specify communicative intentions';
$string['especificar_tipo'] = 'Specify text typology';
...
$string['ref_em'] = 'Reference to the sender';
$string['ex_em'] = 'Exclusion of the sender';
$string['ref_des'] = 'Reference to the receiver';
$string['ex_des'] = 'Exclusion of the receiver';
$string['elem'] = 'Show an element of the statement';
$string['resu'] = 'Show a resumee';
$string['verdesc'] = 'See template';
$string['guardesc'] = 'Save changes';
$string['ayuda'] = 'Help';
$string['cancel'] = 'Main menu';
$string['mascampos'] = 'Other fields';
$string['listado'] = 'Show list';
//preguntas tipologias textuales
$string['quien'] = 'Who is the sender?';
$string['finalidad'] = 'What does he want to transmit?';
$string['a_quien'] = 'To whom?';
$string['medio'] = 'What does he do to transmit the information?';
$string['donde'] = 'Where is the information?';
$string['cuando'] = 'When is the information transmitted?';
$string['motivo'] = 'What is the purpose?';
$string['funcion'] = 'What is the function?';
$string['sobre_que'] = 'About what is the text?';
$string['que'] = 'What?';
$string['orden'] = 'In which order?';
$string['medios_nonverbales'] = 'Which are the non verbal elements?';
$string['que_palabras'] = 'Which words does he use?';
$string['que_frases'] = 'Which phrases does he use?';
$string['que_tono'] = 'Tone?';
$string['mastablas'] = 'Add new table';
$string['masfilas'] = 'Add new row';
$string['muestra_tabla'] = 'Edit table';
$string['nopermisos'] = 'You are not allowed to do that';
...
$string['desc_inten4.1'] = 'It refers to actions made by living things, institutions etc. to achieve something specific.';
