...
$string['modificar'] = 'Ver/Modificar';
$string['eliminar'] = 'Eliminar';
$string['anadir'] = 'Añadir';
$string['anadirNuevo'] = 'Añadir Nuevo';
$string['atras'] = 'Atrás';
$string['id'] = 'Identificador';
$string['todo'] = 'Vínculo con los demás campos'; //$string['todo'] = 'Relación con otros campos';
...
$string['dativo'] = 'Dativ';
$string['acudat'] = 'Ohne Kasus'; //antes ponía Akkusativ + Dativ
