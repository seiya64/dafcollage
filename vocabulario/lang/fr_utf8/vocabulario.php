...
//lo que aquí aparece en alemán es porque tiene que ser así
...
$string['add_gram'] = 'Ajouter un nouveau point grammatical';
...
$string['campo_intencion'] = 'Intention de communication';
...
$string['campo_tipologia'] = 'Typologie textuelle';
...
$string['3per'] = 'Troisième personne du singulier';
$string['3perAv'] = '3ème Pers. sing.';           //Esto tiene que ser la abreviatura de la anterior
...
$string['Añadir'] = 'Ajouter';
$string['AñadirNuevo'] = 'Ajouter Nouveau';
$string['atras'] = 'Aller en arrière';
$string['id'] = 'Nom d’utilisateur';
$string['todo'] = 'Tous les mots';
$string['alfabetico'] = 'Mots suivant l’ordre alphabétique';
$string['nube'] = 'Tableau intéractif';
