...
class mod_vocabulario_opciones_form extends moodleform {
    ...
    function aniadircosas($id) {
        ...
        //} else {
            //1,1
            $tabla_menu .='<td><p><a href="view?id=' . $id . '&opcion=1"><img src="./imagenes/guardar_palabras.png" id="id_guardar_im" name="guardar_im"/></br>' . get_string('guardar', 'vocabulario') . '</a></p></td>';
        //}
        //1,2
        ...
        //1,3
        $tabla_menu .='<td><p><a href="view?id=' . $id . '&opcion=3"><img src="./imagenes/campos_lexicos.png" id="id_campos_im" name="campos_im"/></br>' . get_string('admin_cl', 'vocabulario') . '</a></p></td></tr>';

        //2,1
        $tabla_menu .='<tr><td><p><a href="view?id=' . $id . '&opcion=5"><img src="./imagenes/administrar_gramaticas.png" id="id_gram_im" name="gram_im"/></br>' . get_string('admin_gr', 'vocabulario') . '</a></p></td>';
        //2,2
        ...
        //3,1
        $tabla_menu .='<tr><td><p><a href="view?id=' . $id . '&opcion=7"><img src="./imagenes/intenciones_comunicativas.png" id="id_ic_im" name="ic_im"/></br>' . get_string('admin_ic', 'vocabulario') . '</a></p></td>';
        //3,2
        ...
        //4,1
        $tabla_menu .='<tr><td><p><a href="view?id=' . $id . '&opcion=9"><img src="./imagenes/tipologias_textuales.png" id="id_tt_im" name="tt_im"/></br>' . get_string('admin_tt', 'vocabulario') . '</a></p></td></tr>';
        $tabla_menu .='</table>';
...
class mod_vocabulario_ver_form extends moodleform {
    ...
    function definition() {
        ...
        foreach ($mis_palabras as $cosa) {
            ...
            $fila .= '<td> ' . $cosa->get('sustantivo')->get('palabra') . ' </td>';
            $fila .= '<td> ' . $cosa->get('verbo')->get('infinitivo') . ' </td>';
            $fila .= '<td> ' . $cosa->get('adjetivo')->get('sin_declinar') . ' </td>';
            $fila .= '<td> ' . $cosa->get('otro')->get('palabra') . ' </td>';
            if (!$cl) {
                $fila .= '<td> ' . $cosa->get('campo')->get('campo') . ' </td>';
            }
            $acciones = '<a href="./view?id=' . $this->id_tocho . '&opcion=4&id_mp=' . $cosa->id . '">[' . get_string('editar', 'vocabulario') . ']</a></td>';
            $acciones .= '<td><a href="./guardar?id_tocho=' . $this->id_tocho . '&borrar=' . $cosa->id . '">[' . get_string('eliminar', 'vocabulario') . ']</a>';
            $fila .= '<td> ' . $acciones . ' </td>';
            $fila .= '</tr>';
    ...
    function definition() {
        ...
        switch ($grid) {
            ...
            case 29:
                ...
                $titulillos = '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('S1', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S1PRA" name="S1PRA" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S1PRE" name="S1PRE" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S1PER" name="S1PER" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S1PC1" name="S1PC1" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S1PC2" name="S1PC2" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('S2', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S2PRA" name="S2PRA" value="' . $descripcion_troceada[6] . '"></td>';
                ...
                $titulillos .= '<td><input type="text" size=10 id="id_S2PC1" name="S2PC1" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S2PC2" name="S2PC2" value="' . $descripcion_troceada[7] . '"></td>';$titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('S3', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S3PRA" name="S3PRA" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S3PRE" name="S3PRE" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S3PER" name="S3PER" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S3PC1" name="S3PC1" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_S3PC2" name="S3PC2" value="' . $descripcion_troceada[7] . '"></td>';$titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('P1', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P1PRA" name="P1PRA" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P1PRE" name="P1PRE" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P1PER" name="P1PER" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P1PC1" name="P1PC1" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P1PC2" name="P1PC2" value="' . $descripcion_troceada[7] . '"></td>';$titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('P2', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P2PRA" name="P2PRA" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P2PRE" name="P2PRE" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P2PER" name="P2PER" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P2PC1" name="P2PC1" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P2PC2" name="P2PC2" value="' . $descripcion_troceada[7] . '"></td>';$titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('P3', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P3PRA" name="P3PRA" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P3PRE" name="P3PRE" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P3PER" name="P3PER" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P3PC1" name="P3PC1" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size=10 id="id_P3PC2" name="P3PC2" value="' . $descripcion_troceada[7] . '"></td>';$titulillos .= '</tr>';
                $mform->addElement('html', $titulillos);
                $mform->addElement('html', '</table>');
                $mform->addElement('html', '<p>');
                break;
            ...
            case 8:
                ...
                $titulillos = '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('snominativo', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size="8" id="id_NP1" name="NP1" value="' . $descripcion_troceada[5] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_NP2" name="NP2" value="' . $descripcion_troceada[6] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_NP3" name="NP3" value="' . $descripcion_troceada[7] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_NSIE" name="NSIE" value="' . $descripcion_troceada[8] . '"></td>';
                $titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('sacusativo', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size="8" id="id_AP1" name="AP1" value="' . $descripcion_troceada[14] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_AP2" name="AP2" value="' . $descripcion_troceada[15] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_AP3" name="AP3" value="' . $descripcion_troceada[16] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_ASIE" name="ASIE" value="' . $descripcion_troceada[17] . '"></td>';
                $titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('sdativo', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size="8" id="id_DP1" name="DP1" value="' . $descripcion_troceada[23] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_DP2" name="DP2" value="' . $descripcion_troceada[24] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_DP3" name="DP3" value="' . $descripcion_troceada[25] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_DSIE" name="DSIE" value="' . $descripcion_troceada[26] . '"></td>';
                $titulillos .= '</tr>';
                $titulillos .= '<tr class="cell">';
                $titulillos .= '<td class="cell">' . get_string('sgenitivo', 'vocabulario') . '</td>';
                $titulillos .= '<td><input type="text" size="8" id="id_GP1" name="GP1" value="' . $descripcion_troceada[32] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_GP2" name="GP2" value="' . $descripcion_troceada[33] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_GP3" name="GP3" value="' . $descripcion_troceada[34] . '"></td>';
                $titulillos .= '<td><input type="text" size="8" id="id_GSIE" name="GSIE" value="' . $descripcion_troceada[35] . '"></td>';
                $titulillos .= '</tr>';
                $mform->addElement('html', $titulillos);
                $mform->addElement('html', '</table>');
                $mform->addElement('html', '<p>');
