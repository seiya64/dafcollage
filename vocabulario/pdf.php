...
define('RojoG',86);
define('RojoB',101);
define('RojoSubtituloR',127);
define('RojoSubtituloG',47);
define('RojoSubtituloB',55);
define('RojoTablaR',191);
define('RojoTablaG',70);
define('RojoTablaB',83);
                    ...
                    if ($pintartochaco) {
                        ...
                        switch ($grid) {
                            ...
                            case 3:
                                ...
                                //masculino
                                $pdf->SetTextColor(RojoSubtituloR,RojoSubtituloG,RojoSubtituloB);
