...
define('TextGrisG', 90);
define('TextGrisB', 90);
define('GrisOscuroR', 220);
define('GrisOrcuroG', 220);
define('GrisOrcuroB', 220);
define('GrisClaroR', 235);
define('GrisClaroG', 235);
define('GrisClaroB', 235);

//Para ficha de estudio
...
define('RojoG',86);
define('RojoB',101);
define('RojoTituloR',232);
define('RojoTituloG',67);
define('RojoTituloB',84);
...
//Para tiopologías
define('AmarilloR',255);
define('AmarilloG',204);
define('AmarilloB',0);
define('AmarilloTituloR',255);
define('AmarilloTituloG',204);
define('AmarilloTituloB',0);
define('AmarilloTablaR',255);
define('AmarilloTablaG',204);
define('AmarilloTablaB',0);
...
//Quitas las lineas de cabecera y pie
...
if($impr_vocab_corto) {
    ...
    foreach($datos as $ct=>$palabras) {
        ...
        foreach($palabras as $pal=>$atrs) {
            ...
            if($atrs['genero'] == 'die'){
                $pdf->SetFont('freeserif', 'B', '10');
                $pdf->SetTextColor(RojoR, RojoG, RojoB); //Rosa
            }
            //Masculino
            if($atrs['genero'] == 'der'){
                $pdf->SetFont('freeserif', 'B', '10');
            ...
            if($atrs['genero'] == 'das'){
                $pdf->SetFont('freeserif', 'B', '10');
                $pdf->SetTextColor(25, 163, 71); //Verde
            }
                    ...
                    if ($pintartochaco) {
                        ...
                        switch ($grid) {
                            ...
                            case 3:
                                ...
                                $pdf->setLeftMargin(MARGIN);
                                $pdf->SetTextColor(RojoR,RojoG,RojoB);
                                $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('clasificacionsemantica', 'vocabulario') . '</h4>', 0, 1, 0);
                                $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->MultiCell(0, 5, $descripcion_troceada[0], 0, 'L', 0);
                                $pdf->Ln();
                                $pdf->SetTextColor(RojoR,RojoG,RojoB);
                                $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('clasificacionformal', 'vocabulario') . '</h4>', 0, 1, 0);
                                $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
...
//                                $pdf->Ln();
                            ...
                            case 22:
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->Cell(56, 5, get_string('schwache', 'vocabulario') . '*', 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, get_string('starke', 'vocabulario') . '**', 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, get_string('gemischte', 'vocabulario') . '***', 0, 1, 'C', 1);
                                        ...
                                        $pdf->Cell(22, 5, get_string('infinitivo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 0], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 7], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 14], 0, 1, 'C', 1);
                                        ...
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('S1', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 1], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 8], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 15], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('S2', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 2], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 9], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 16], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('S3', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 3], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 10], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 17], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('P1', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 4], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 11], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 18], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('P2', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 5], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 12], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 19], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('P3', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 6], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 13], 0, 0, 'C', 1);
                                        $pdf->Cell(56, 5, $descripcion_troceada[(21 * $i) + 20], 0, 1, 'C', 1);
                            ...
                            case 34:
                                ...
                                //cabecera
                                $pdf->Ln();
                                $pdf->Cell(110, 5, get_string('schwache_siehe', 'vocabulario'), 0, 1, 'C', 1);

                                //filas
                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                $pdf->Cell(24, 5, get_string('S1', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(86, 5, $descripcion_troceada[0], 0, 1, 'C', 1);

                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                $pdf->Cell(24, 5, get_string('S2', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(86, 5, $descripcion_troceada[1], 0, 1, 'C', 1);

                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                $pdf->Cell(24, 5, get_string('S3', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(86, 5, $descripcion_troceada[2], 0, 1, 'C', 1);

                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                $pdf->Cell(24, 5, get_string('P1', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(86, 5, $descripcion_troceada[3], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(86, 5, $descripcion_troceada[4], 0, 1, 'C', 1);

                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                $pdf->Cell(24, 5, get_string('P3', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(86, 5, $descripcion_troceada[5], 0, 1, 'C', 1);
                                ...
                                $pdf->SetFillColor(RojoTablaR,RojoTablaG,RojoTablaB);
                                //cabecera
                                $pdf->Cell(24, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(166, 5, get_string('starke', 'vocabulario'), 0, 1, 'C', 1);
                                $pdf->Cell(24, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, get_string('preterito', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, get_string('conjuntivo2', 'vocabulario'), 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(83, 5, $descripcion_troceada[6], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[7], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(83, 5, $descripcion_troceada[8], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[9], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(83, 5, $descripcion_troceada[10], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[11], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(83, 5, $descripcion_troceada[12], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[13], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(83, 5, $descripcion_troceada[14], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[15], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(83, 5, $descripcion_troceada[16], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[17], 0, 1, 'C', 1);
                            ...
                            case 29:
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->Cell(170, 5, $descripcion_troceada[(31 * $i) + 0], 0, 1, 'C', 1);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        ...
                                        $pdf->Cell(102, 5, get_string('indicativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(68, 5, get_string('conjuntivo', 'vocabulario'), 0, 1, 'C', 1);

                                        //cabeceras
                                        $pdf->SetFillColor(RojoTablaR,RojoTablaG,RojoTablaB);
                                        $pdf->Cell(20, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, get_string('prasens', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, get_string('preterito', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, get_string('perfecto', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, get_string('conjuntivo1', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, get_string('conjuntivo2', 'vocabulario'), 0, 1, 'C', 1);
                                        ...
                                        $pdf->Cell(20, 5, get_string('S1', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 1], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 2], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 3], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 4], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 5], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(20, 5, get_string('S2', 'vocabulario'), 0, 0, 'C', 1);
                                         $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 6], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 7], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 8], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 9], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 10], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(20, 5, get_string('S3', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 11], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 12], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 13], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 14], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 15], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(20, 5, get_string('P1', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 16], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 17], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 18], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 19], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 20], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(20, 5, get_string('P2', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 21], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 22], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 23], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 24], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 25], 0, 1, 'C', 1);

                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(20, 5, get_string('P3', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 26], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 27], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 28], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 29], 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(31 * $i) + 30], 0, 1, 'C', 1);
                            ...
                            case 33:
                                ...
                                $pdf->Ln();
                                $pdf->Cell(24, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, get_string('sein', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, get_string('andere', 'vocabulario'), 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(83, 5, $descripcion_troceada[0], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[1], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(83, 5, $descripcion_troceada[2], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[3], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(83, 5, $descripcion_troceada[4], 0, 0, 'C', 1);
                                $pdf->Cell(83, 5, $descripcion_troceada[5], 0, 1, 'C', 1);
                            ...
                            case 15:
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        //cabecera grande
                                        $pdf->Ln();
                                        $pdf->Cell(190, 6, get_string('possessiv1', 'vocabulario'), 0, 1, 'C', 1);
                                        //separador
                                       // $pdf->Cell(190, 3, '', 0, 1, 'C', 0);
                                        ...
                                        $pdf->SetFillColor(RojoTablaR,RojoTablaG,RojoTablaB);
                                        $pdf->Cell(20, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(170, 5, get_string('singAl', 'vocabulario'), 0, 1, 'C', 1);
                                        $pdf->Cell(20, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, '1', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, '2', 0, 0, 'C', 1);
                                        $pdf->Cell(102, 5, '3', 0, 1, 'C', 1);

                                        $pdf->Cell(20, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, 'm', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, 'n', 0, 0, 'C', 1);
                                        $pdf->Cell(34, 5, 'f', 0, 1, 'C', 1);
                                        ...
                                        $pdf->Cell(20, 5, get_string('nominativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(25 * $i) + 0], 0, 0, 'C', 0);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(25 * $i) + 1], 0, 0, 'C', 0);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(25 * $i) + 2], 0, 0, 'C', 0);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(25 * $i) + 3], 0, 0, 'C', 0);
                                        $pdf->Cell(34, 5, $descripcion_troceada[(25 * $i) + 4], 0, 1, 'C', 0);
                                        ...
                                        $pdf->Cell(20, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(126, 5, get_string('pluralAl', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(44, 5, '', 0, 1, 'C', 1);

                                        $pdf->Cell(20, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, '1', 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, '2', 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, '3', 0, 0, 'C', 1);
                                        $pdf->Cell(44, 5, get_string('sie', 'vocabulario'), 0, 1, 'C', 1);
                                        ...
                                        $pdf->Cell(20, 5, get_string('nominativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 5], 0, 0, 'C', 0);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 6], 0, 0, 'C', 0);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 7], 0, 0, 'C', 0);
                                        $pdf->Cell(44, 5, $descripcion_troceada[(25 * $i) + 8], 0, 1, 'C', 0);
                                        ...
                                        $pdf->Cell(190, 6, get_string('declinacion_siehe', 'vocabulario'), 0, 1, 'C', 1);

                                        //cabeceras chicas tabla 2
                                        $pdf->SetFont('freeserif', 'B', 10);

                                        $pdf->Cell(22, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, get_string('masculino', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, get_string('neutro', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, get_string('femenino', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, get_string('pluralAl', 'vocabulario'), 0, 1, 'C', 1);
                                        ...
                                        $pdf->Cell(22, 5, get_string('nominativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 9], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 10], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 11], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 12], 0, 1, 'C', 1);
                                        
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('acusativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 13], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 14], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 15], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 16], 0, 1, 'C', 1);
                                        
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('dativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 17], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 18], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 19], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 20], 0, 1, 'C', 1);
                                        
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(22, 5, get_string('genitivo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 21], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 22], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 23], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(25 * $i) + 24], 0, 1, 'C', 1);
                            ...
                            case 39:
                                ...
                                //cabecera grande
                                $pdf->Ln();
                                $pdf->Cell(190, 6, get_string('possessiv2', 'vocabulario'), 0, 1, 'C', 1);
                                //separador
                               // $pdf->Cell(190, 3, '', 0, 1, 'C', 0);
                                ...
                                $pdf->Cell(20, 5, get_string('nominativo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->Cell(34, 5, $descripcion_troceada[0], 0, 0, 'C', 0);
                                $pdf->Cell(34, 5, $descripcion_troceada[1], 0, 0, 'C', 0);
                                $pdf->Cell(34, 5, $descripcion_troceada[2], 0, 0, 'C', 0);
                                $pdf->Cell(34, 5, $descripcion_troceada[3], 0, 0, 'C', 0);
                                $pdf->Cell(34, 5, $descripcion_troceada[4], 0, 1, 'C', 0);
                                ...
                                $pdf->Cell(20, 5, get_string('nominativo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->Cell(42, 5, $descripcion_troceada[5], 0, 0, 'C', 0);
                                $pdf->Cell(42, 5, $descripcion_troceada[6], 0, 0, 'C', 0);
                                $pdf->Cell(42, 5, $descripcion_troceada[7], 0, 0, 'C', 0);
                                $pdf->Cell(44, 5, $descripcion_troceada[8], 0, 1, 'C', 0);
                                ...
                                //cabecera grande
                                $pdf->Cell(190, 6, get_string('endungen_siehe4', 'vocabulario'), 0, 1, 'C', 1);
                               ...
                               // $pdf->Ln();
                                ...
                                if ($pintar) {
                                    ...
                                    $pdf->Cell(22, 5, '',0, 0, 'C', 1);
                                    $pdf->Cell(168, 5, get_string('declinacion4', 'vocabulario'), 0, 1, 'C', 1);
                                    ...
                                    $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                    $pdf->SetFillColor(TEXT_WHITE);
                                    $pdf->Cell(42, 5, $descripcion_troceada[9], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[10], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[11], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[12], 0, 1, 'C', 1);
                                    ...
                                    $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                    $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                    $pdf->Cell(42, 5, $descripcion_troceada[13], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[14], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[15], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[16], 0, 1, 'C', 1);
                                    ...
                                    $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                    $pdf->SetFillColor(TEXT_WHITE);
                                    $pdf->Cell(42, 5, $descripcion_troceada[17], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[18], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[19], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[20], 0, 1, 'C', 1);
                                    ...
                                    $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                    $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                    $pdf->Cell(42, 5, $descripcion_troceada[21], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[22], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[23], 0, 0, 'C', 1);
                                    $pdf->Cell(42, 5, $descripcion_troceada[24], 0, 1, 'C', 1);
                            ...
                            case 5:
                                ...
                                switch ($grid) {
                                    case 40:
                                        $pdf->SetTextColor(TEXT_WHITE);
                                        $pdf->Ln();
                                        $pdf->Cell(190, 6, get_string('endungen_siehe1', 'vocabulario'), 0, 1, 'C', 1);
                                       // $pdf->Ln();
                                        $tablasiempre = false;
                                        break;
                                    case 42:
                                        $pdf->SetTextColor(TEXT_WHITE);
                                        $pdf->Ln();
                                        $pdf->Cell(190, 6, get_string('endungen_siehe3', 'vocabulario'), 0, 1, 'C', 1);
                                        $pdf->Ln();
                                        $tablasiempre = false;
                                        break;
                                }
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 0], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 1], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 2], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 3], 0, 1, 'C', 1);
                                        ...
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 4], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 5], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 6], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 7], 0, 1, 'C', 1);
                                        ...
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 8], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 9], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 10], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 11], 0, 1, 'C', 1);
                                        ...
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 12], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 13], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 14], 0, 0, 'C', 1);
                                        $pdf->Cell(42, 5, $descripcion_troceada[(16 * $i) + 15], 0, 1, 'C', 1);
                            ...
                            case 8:
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->Ln();
                                        $pdf->Cell(24, 5, '', 0, 0, 'C', 1);
                                        $pdf->Cell(83, 5, get_string('person', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->Cell(83, 5, get_string('nichtperson', 'vocabulario'), 0, 1, 'C', 1);
                                        ...
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 0], 0, 0, 'C', 1);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 1], 0, 1, 'C', 1);
                                        
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR, RojoG, RojoB);
                                        
                                        $pdf->Cell(24, 5, get_string('acusativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 2], 0, 0, 'C', 1);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 3], 0, 1, 'C', 1);
                                        
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR, RojoG, RojoB);
                                        
                                        $pdf->Cell(24, 5, get_string('dativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 4], 0, 0, 'C', 1);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 5], 0, 1, 'C', 1);
                                        
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR, RojoG, RojoB);
                                        
                                        $pdf->Cell(24, 5, get_string('genitivo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 6], 0, 0, 'C', 1);
                                        $pdf->Cell(83, 5, $descripcion_troceada[(8 * $i) + 7], 0, 1, 'C', 1);
                            ...
                            case 56:
                                ...
                                $pdf->Ln();
                                $pdf->Cell(40, 5, get_string('vorfeld', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(30, 5, get_string('konjugier_resumen', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(90, 5, get_string('mittelfeld', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(37, 5, get_string('verb2', 'vocabulario'), 0, 1, 'C', 1);
                            ...
                            case 57:
                                ...
                                $pdf->Ln();
                                $pdf->Cell(20, 5, get_string('subjunktor', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(25, 5, get_string('subjekt', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(85, 5, get_string('mittelfeld', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(30, 5, get_string('verb2', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(25, 5, get_string('konjugier_resumen', 'vocabulario'), 0, 1, 'C', 1);
                                ...
                                for ($f = 0; $f < $totalfilas; $f++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->Cell(25, 5, $descripcion_troceada[($f * 5) + 1], 0, 1, 'C', 1);
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                       ...
                                       // $pdf->Cell(110, 4, '', 0, 1, 'C', 1);
                                        ...
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(86, 5, $descripcion_troceada[(5 * $i) + 2], 0, 1, 'C', 1);
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(24, 5, get_string('dativo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                        $pdf->Cell(86, 5, $descripcion_troceada[(5 * $i) + 3], 0, 1, 'C', 1);
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->SetFillColor(RojoR,RojoG,RojoB);
                                        $pdf->Cell(24, 5, get_string('genitivo', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(TEXT_WHITE);
                                        $pdf->Cell(86, 5, $descripcion_troceada[(5 * $i) + 4], 0, 1, 'C', 1);
                            ...
                            case 7:
                                ...
                                $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(34, 5, $descripcion_troceada[0], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[1], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[2], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[3], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[4], 0, 1, 'C', 1);
                                
                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR, RojoG, RojoB);

                                $pdf->Cell(20, 5, get_string('acusativo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                $pdf->Cell(34, 5, $descripcion_troceada[9], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[10], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[11], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[12], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[13], 0, 1, 'C', 1);
                                
                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR, RojoG, RojoB);

                                $pdf->Cell(20, 5, get_string('dativo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(34, 5, $descripcion_troceada[18], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[19], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[20], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[21], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[22], 0, 1, 'C', 1);
                                
                                $pdf->setTextColor(TEXT_WHITE);
                                $pdf->SetFont('freeserif', '', 10);
                                $pdf->SetFillColor(RojoR, RojoG, RojoB);

                                $pdf->Cell(20, 5, get_string('genitivo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                $pdf->Cell(34, 5, $descripcion_troceada[27], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[28], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[29], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[30], 0, 0, 'C', 1);
                                $pdf->Cell(34, 5, $descripcion_troceada[31], 0, 1, 'C', 1);
                               ...
                               $pdf->setTextColor(TEXT_WHITE);
                                ...
                                $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(42, 5, $descripcion_troceada[5], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[6], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[7], 0, 0, 'C', 1);
                                $pdf->Cell(44, 5, $descripcion_troceada[8], 0, 1, 'C', 1);
                                ...
                                $pdf->Cell(42, 5, $descripcion_troceada[14], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[15], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[16], 0, 0, 'C', 1);
                                $pdf->Cell(44, 5, $descripcion_troceada[17], 0, 1, 'C', 1);
                                ...
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(42, 5, $descripcion_troceada[23], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[24], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[25], 0, 0, 'C', 1);
                                $pdf->Cell(44, 5, $descripcion_troceada[26], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR, TextGrisG, TextGrisB);
                                $pdf->SetFillColor(GrisClaroR, GrisClaroG, GrisClaroB);
                                $pdf->Cell(42, 5, $descripcion_troceada[32], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[33], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[34], 0, 0, 'C', 1);
                                $pdf->Cell(44, 5, $descripcion_troceada[35], 0, 1, 'C', 1);
                            ...
                            case 35:
                                ...
                                for ($i = 0; $i < $numtablas; $i++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->Cell(24, 5, get_string('S2', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->Cell(86, 5, $descripcion_troceada[(4 * $i) + 1], 0, 1, 'C', 0);
                                        $pdf->setTextColor(TEXT_WHITE);
                                        $pdf->Cell(24, 5, get_string('P2', 'vocabulario'), 0, 0, 'C', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                            ...
                            case 30:
                                ...
                                //cabecera grande
                                $pdf->Ln();
                                $pdf->Cell(190, 6, get_string('reflexivo', 'vocabulario'), 0, 1, 'C', 1);
                                //separador
                                //$pdf->Cell(190, 3, '', 0, 1, 'C', 0);
                                ...
                                $pdf->Cell(22, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(168, 5, get_string('singAl', 'vocabulario'), 0, 1, 'C', 1);
                                $pdf->Cell(22, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, '1', 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, '2', 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, '3', 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(56, 5, $descripcion_troceada[0], 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, $descripcion_troceada[1], 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, $descripcion_troceada[2], 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(GrisClaroR,GrisClaroG,GrisClaroB);
                                $pdf->Cell(56, 5, $descripcion_troceada[7], 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, $descripcion_troceada[8], 0, 0, 'C', 1);
                                $pdf->Cell(56, 5, $descripcion_troceada[9], 0, 1, 'C', 1);
                                ...
                                $pdf->Cell(22, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(126, 5, get_string('pluralAl', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, '', 0, 1, 'C', 1);

                                $pdf->Cell(22, 5, '', 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, '1', 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, '2', 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, '3', 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, get_string('sie', 'vocabulario'), 0, 1, 'C', 1);
                                ...
                                $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                $pdf->SetFillColor(TEXT_WHITE);
                                $pdf->Cell(42, 5, $descripcion_troceada[3], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[4], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[5], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[6], 0, 1, 'C', 1);
                                ...
                                $pdf->Cell(42, 5, $descripcion_troceada[10], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[11], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[12], 0, 0, 'C', 1);
                                $pdf->Cell(42, 5, $descripcion_troceada[13], 0, 1, 'C', 1);
                            ...
                            case 43:
                                ...
                                for ($tabla = 0; $tabla < 3; ++$tabla) {
                                    ...
                                    $pdf->Cell(75, 5, $titulo, 0, 0, 'C', 1);
                                    $pdf->Cell(75, 5, get_string('gebrauch', 'vocabulario'), 0, 1, 'C', 1);
                                    ...
                                    for ($fila = 0; $fila < $tope; $fila++) { 
                                        ...
                                        if ($pintar) {
                                            ...
                                            $pdf->Cell(75, 5, $descripcion_troceada[($tabla * $tope * 2) + ((2 * $fila) + 0)], 0, 0, 'C', 0);
                                            $pdf->Cell(75, 5, $descripcion_troceada[($tabla * $tope * 2) + ((2 * $fila) + 1)], 0, 1, 'C', 0);
                                        }
                                    }
                                    $pdf->setLeftMargin(MARGIN);
                                    $pdf->Ln();
                            ...
                            case 48:
                                ...
                                $pdf->Ln();
                                $pdf->Cell(63, 5, get_string('positivo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(64, 5, get_string('comparativo', 'vocabulario'), 0, 0, 'C', 1);
                                $pdf->Cell(63, 5, get_string('superlativo', 'vocabulario'), 0, 1, 'C', 1);
                                ...
                                for ($f = 0; $f < $totalfilas; $f++) {
                                    ...
                                    if ($pintar) {
                                        ...
                                        $pdf->Multicell(63, 10, $descripcion_troceada[($f * 3)], 0, 'L', 0, 0);
                                        $pdf->Multicell(64, 10, $descripcion_troceada[($f * 3) + 1], 0,'L', 0, 0);
                                        $pdf->Multicell(63, 10, $descripcion_troceada[($f * 3) + 2], 0, 'L', 0, 1);
...
//                                    $titulillos .='<th>'.get_string('beisp','vocabulario').'</th>';
                                ...
                                for ($j = 0; $j < count($arrayAux) && $salidor == false; $j++) {
                                    ...
                                    if (!$desc_aux[0]) {
                                        ...
                                        $pdf->SetTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', 'B', 10);
                                        $pdf->Cell(18, 5, get_string('func', 'vocabulario'), 0, 0, 'L', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->Cell(172, 5, $desc_aux[1], 0, 1, 'L', 0);

                                        $pdf->SetTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', 'B', 10);
                                        $pdf->Cell(18, 5, get_string('kas', 'vocabulario'), 0, 0, 'L', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->Cell(172, 5, $kasus[$desc_aux[2]], 0, 1, 'L', 0);
                                        
                                        $pdf->SetTextColor(TEXT_WHITE);
                                        $pdf->SetFont('freeserif', 'B', 10);
                                        $pdf->Cell(18, 5, get_string('beisp', 'vocabulario'), 0, 0, 'L', 1);
                                        $pdf->setTextColor(TextGrisR,TextGrisG,TextGrisB);
                                        $pdf->SetFont('freeserif', '', 10);
                                        $pdf->MultiCell(172, 5, $desc_aux[3], 0, 'L', 0);
                                    }
                                }
                                $pdf->Ln();
                                break;
                        ...
                        $pdf->SetLineWidth(0.3);
                        $pdf->SetFont('freeserif', 'B', '12');
                        $pdf->Cell(47, 5, get_string('atencion_may', 'vocabulario'), 0, 1, 'C', 1);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->SetFont('freeserif', '', '10');
                        $pdf->MultiCell(170, 5, $descripcion_troceada[count($descripcion_troceada) - 2], 0, 'L', 0);
                        $pdf->Ln();
                        $pdf->SetTextColor(TEXT_WHITE);
                        $pdf->SetFont('freeserif', 'B', '12');
                        $pdf->Cell(47, 5, get_string('miraren', 'vocabulario'), 0, 1, 'C', 1);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->SetFont('freeserif', '', '10');
                        $pdf->MultiCell(170, 5, $descripcion_troceada[count($descripcion_troceada) - 1], 0, 'L', 0);
    ...
    foreach ($todas as $cosa) {
        ...
        if ($descripcion_troceada) {
            ...
            if ($pintartochaco) {
                ...
                $pdf->SetTextColor(AmarilloTituloR,AmarilloTituloG,AmarilloTituloB);
                $pdf->SetFont('freeserif', 'B', '12');
//                $pdf->Cell(0, 5, $mtt, 0, 1, 'L', 0);
                $pdf->setLeftMargin(MARGIN);

                $pdf->writeHTMLCell(0, 0, 9, 5, '<h2>' . $mtt . '</h2>', 0, 1, 0);
                $pdf->Ln();
                ...
                for ($i = 0; $i < $numplantillas; $i++) {
                    ...
                    if ($pintar) {
                        ...
                        $pdf->SetFont('freeserif', 'B', '12');
                        $pdf->SetLineWidth(0.3);
                        $pdf->SetFillColor(AmarilloTablaR,AmarilloTablaG,AmarilloTablaB);
                        ...
                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0,10, null, '<h4>' . get_string('quien', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 0], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();
  
                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('finalidad', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 1], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('a_quien', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 2], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('medio', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 3], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('donde', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 4], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('cuando', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 5], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('motivo', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 6], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('funcion', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 7], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('sobre_que', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 8], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('que', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 9], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('orden', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 10], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('medios_nonverbales', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 11], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('que_palabras', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 12], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('que_frases', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 13], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();

                        $pdf->SetTextColor(AmarilloR,AmarilloG,AmarilloB);
                        $pdf->writeHTMLCell(0, 0, 10, null, '<h4>' . get_string('que_tono', 'vocabulario') . '</h4>', 0, 1, 0);
                        $pdf->SetTextColor(TextGrisR,TextGrisG,TextGrisB);
                        $pdf->MultiCell(0, 5, $descripcion_troceada[(15 * $i) + 14], 0, 'L', false, 1, '', '', true, 0, false, true, 0, '', false);
                        $pdf->Ln();
