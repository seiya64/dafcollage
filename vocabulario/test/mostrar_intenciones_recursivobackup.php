...
$consulta_int = sprintf("SELECT id, intencion FROM mdl19_vocabulario_intenciones_es
...
if ($numero_int==0){ 
   ...
   $contador = 0;
    while ($fila = mysql_fetch_assoc($resultado)) {
            ...
            $consulta_sub_int = sprintf("SELECT id FROM mdl19_vocabulario_intenciones_es
            WHERE padre=".$padre. " order by id");
