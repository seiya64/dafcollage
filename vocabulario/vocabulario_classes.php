...
class Vocabulario_verbo {
     ...
     * @param type $id
     */
    function Vocabulario_verbo($infi=' ', $ter='', $pre='', $par='', $sig='', $obs='', $grid=20, $inid=1, $tipid=1, $id=1) {
...
class Vocabulario_campo_lexico {
    ...
    function obtener_todos($usuarioid) {
        $campos_lexicos = get_records_select('vocabulario_camposlexicos', 'usuarioid=' . $usuarioid . ' or usuarioid=0');
        $clex = array();
