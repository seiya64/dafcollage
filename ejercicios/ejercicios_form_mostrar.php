...
class mod_ejercicios_mostrar_ejercicio extends moodleform_mod {
    ...
    function mostrar_ejercicio($id, $p, $id_ejercicio, $tipo_origen, $buscar) {
        ...
        // Se obtiene el ejercicio general
        ...
        switch ($tipo_origen) {
            ...
            case 1: // En caso de que sea texto
                ...
                if ($buscar == 0 && modificable == true) { // Si estamos creando el ejercicio
                    ...
                    if ($buscar == 1 && $modificable == false) { // Buscamos y no tenemos permiso de edición (alumno o profesor sin permiso)
                        $divtexto = '<div class="desctexto" name="texto" id="texto"><div class="margenes">' . nl2br((stripslashes($origen_texto->get('texto')))) . '</div></div>';
                    } else { // Buscamos y tenemos permiso de edición
        ...
        // Si estoy creando el ejercicio creo una primera pregunta de inicio
        if ($buscar == 0 && $modificable == true) {
            // La pregunta de inicio
            $pregunta= new Ejercicios_texto_texto_preg(NULL,$id_ejercicio, "Introduzca la pregunta..."); // Atención, cadena de texto a añadir
            $id_preg=$pregunta->insertar();
        }
