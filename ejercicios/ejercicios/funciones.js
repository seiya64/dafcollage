...
function botonASTextoAudio(id_ejercicio){
     ...
     sig_preg=parseInt(num_preg.value)+1;
           ...
           // elemdiv.setAttribute("class","claseaudio1");
            ...
            elememb.setAttribute("flashvars","file=./mediaplayer/audios/audio_"+id_ejercicio+'_'+sig_preg+".mp3&amp;height=20&amp;width=320");
            ...
            dentroscript2=document.createTextNode("var so"+id_ejercicio+"_"+sig_preg+" = new SWFObject('./mediaplayer/mediaplayer.swf','mpl','320','20','7'); "+" so.addParam('allowfullscreen','true');" + " so.addVariable('file','./mediaplayer/audios/audio_"+id_ejercicio+"_"+sig_preg+".mp3'); "+"  so.addVariable('height','20');" + "  so.addVariable('width','320');" + "so.write('player1');");
